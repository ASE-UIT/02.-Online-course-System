...
export default function LessonParts({
  ...
  return (
    <div>
      ...
      >
        <p className="text-text/md/medium line-clamp-2 break-words">
          {module?.partName}
        </p>
        {!showLessons && (
          <ChevronDown className="min-w-[24px] h-[24px] text-black-300" />
        )}
        {showLessons && (
          <ChevronUp className="min-w-[24px] h-[24px] text-black-300" />
        )}
      </div>
      {showLessons && (
