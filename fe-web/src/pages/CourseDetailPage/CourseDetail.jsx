            ...
            <div className="flex px-24 py-[24px] gap-12">
                <div className="max-w-[60%]">
                    <div className="border-[4px] border-primary-100 rounded-[12px]">
                        <header
                            className="bg-primary-100 text-primary-500 text-center leading-[48px] text-text/lg/semibold w-[240px] h-[48px] rounded-br-[4px] inline-block">
                            Bạn sẽ học được
                        </header>
                    ...
                    <div className={` border-[4px] relative mt-4 border-success-100 rounded-[12px]`}>
                        <header
                            className="bg-success-100 text-success-700 text-center leading-[48px] text-text/lg/semibold w-[240px] h-[48px] rounded-br-[4px] inline-block">
                            Giới thiệu khóa học
                        </header>
                        <div
                        ...
                        >
                            ...
                            {showMore ? <ArrowUp className="h-[18px] w-[18px]"/> :
