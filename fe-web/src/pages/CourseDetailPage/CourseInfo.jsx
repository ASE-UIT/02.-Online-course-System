                ...
                <div className="mt-6 flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-text/md/regular">
                            Thời lượng:{" "}
                            <span
                                className="text-text/md/semibold">{convertToHoursAndMinutes(course?.duration / 60)}</span>
                        </p>
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-text/md/regular">
                            Giáo trình: <span
                            className="text-text/md/semibold">{course?.lessonParts?.length} bài giảng</span>
                        </p>
                    </div>
                    <div className="flex items-center gap-2">
