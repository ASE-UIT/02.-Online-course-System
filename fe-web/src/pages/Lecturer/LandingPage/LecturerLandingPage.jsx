...
} from "@/assets/LecturerLandingIconReason.jsx";
    ...
    <div className="w-full h-full">
      <section>
        <section className="bg-warning-50 pt-20">
          <div className="w-9/12 mx-auto max-h-fit flex  justify-between space-x-8">
            <div className="text-left max-w-md max-h-fit  pt-2">
              <h2 className="text-display/md/bold text-black-500">
                Hãy đến giảng dạy với chúng tôi
              </h2>
              <p className="text-text/md/regular pt-2.5 space-y-4">
        ...
        <section className="py-10">
          <div className="max-w-full mx-auto  sm:px-6 px-8 text-center">
            <h2 className="text-display/sm/semibold">
            ...
            <div className="flex justify-around pt-5 ">
              <div className="w-1/4 flex flex-col items-center text-center p-1">
                ...
                <p className=" text-text/md/regular">
                  ...
                  có quyền kiểm soát nội dung của riêng mìnhn
                </p>
              </div>
              <div className="w-1/4 flex flex-col items-center text-center p-1">
                <div>
                  ...
                  <div className="w-9/12 mx-auto max-h-full flex justify-between space-x-8 px-16">
                    ...
                    <div className="text-left my-11 max-h-fit pt-2 px-5">
                      <p className="text-text/md/regular mb-2">
                        Hãy bắt đầu với niềm đam mê và kiến thức của bạn. Sau
                        đó, bạn có thể chọn một chủ đề triển vọng với sự trợ
                        giúp của công cụ
                      </p>
                      <p className="text-text/md/regular mb-2">
                      ...
                      <p className="text-text/md/regular mb-2">
                        Bạn là người quyết định phương pháp cũng như kiến thức
                        giảng dạy.
                      </p>
                      <p className="text-text/md/bold mb-2">
                        Cách chúng tôi trợ giúp bạn
                      </p>
                      <p className="text-text/md/regular mb-2">
                        Chúng tôi cung cấp nhiều tài nguyên về cách tạo khóa học
                        đầu tiên. Ngoài ra, bảng điều khiển của giảng viên và
                        trang khung chương trình của chúng tôi sẽ giúp bạn tổ
                        chức khóa học hiệu quả
                      </p>
                    </div>
                    {/* Image */}
              ...
              <Tabs.Content value="tab2" className="p-4">
                <section>
                  <div className="w-9/12 mx-auto max-h-full flex justify-between space-x-8 px-16">
                    ...
                    <div className="text-left my-11 max-h-fit pt-2 px-5">
                      <p className="text-text/md/regular mb-2">
                        Sử dụng các công cụ cơ bản như điện thoại thông minh
                        hoặc camera DSLR. Thêm một chiếc micrô tốt là bạn đã sẵn
                        sàng bắt đầu.
                      </p>
                      <p className="text-text/md/regular mb-2">
                        Nếu không thích xuất hiện trên camera, bạn chỉ cần ghi
                        lại màn hình của mình . Dù với cách nào thì bạn cũng nên
                        quay video dài từ 2 tiếng trở lên cho khóa học có trả
                        phí.
                      </p>
                      <p className="text-text/md/bold mb-2">
                        Cách chúng tôi trợ giúp bạn
                      ...
                      <p className="text-text/md/regular mb-2">
                        Nhóm Hỗ trợ của chúng tôi luôn sẵn sàng trợ giúp bạn
                        trong suốt quá trình thực hiện và đưa ra phản hồi về
                        video thử nghiệm.
                      </p>
                    </div>
                    {/* Image */}
              ...
              <Tabs.Content value="tab3" className="p-4">
                <section>
                  <div className="w-9/12 mx-auto max-h-full flex justify-between space-x-8 px-16">
                    ...
                    <div className="text-left my-11 max-h-fit pt-2 px-5">
                      <p className="text-text/md/regular mb-2">
                        Thu thập các xếp hạng và đánh giá đầu tiên bằng cách
                        quảng bá khóa học trên mạng xã hội và mạng lưới nghề
                        nghiệp của bạn. Người dùng sẽ dễ dàng khám phá khóa học
                        của bạn trên cổng khóa học của chúng tôi. Đây là nơi bạn
                        kiếm được doanh thu từ mỗi lượt ghi danh có trả phí.
                      </p>
                      <p className="text-text/md/regular mb-2">
                        Nếu không thích xuất hiện trên camera, bạn chỉ cần ghi
                        lại màn hình của mình . Dù với cách nào thì bạn cũng nên
        ...
        <div className="flex flex-col items-center justify-between text-center max-w-full space-y-5">
          <div>
            <React.Suspense fallback={<div>Loading...</div>}>
              <img src={LecturerLandingIcon7} alt="Lecturer Landing Icon" />
            </React.Suspense>
          </div>
          <p className="text-display/sm/semibold">
            Bạn sẽ không phải làm việc này một mình
          </p>
          <p className="text-text/sm/regular w-1/2">
            Nhóm Hỗ trợ giảng viên luôn có mặt để giải đáp thắc mắc cũng như
            đánh giá video thử nghiệm của bạn. Đồng thời, Teaching Center cung
            cấp cho bạn nhiều tài nguyên để giúp bạn trong suốt quá trình làm
            việc. Ngoài ra, bạn sẽ nhận được sự hỗ trợ từ các giảng viên giàu
            kinh nghiệm trong cộng đồng online.
          </p>
        </div>
      </section>
