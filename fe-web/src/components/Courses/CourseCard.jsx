      ...
      <div className=" p-3 items-center ">
        ...
        <div className="flex items-center gap-2 opacity-70">
          <div className="rating flex justify-center items-center gap-3">
            ...
            <h1 className="text-text/xs/regular text-black-300"> ( {23} đánh giá) </h1>
          </div>
        </div>
        <div className="items-center justify-between py-1">
          <p className="text-2xl  font-bold text-primary text-text/md/bold">đ{formatCurrency(course.price)}</p>
        </div>
        {/* {promotion && (
