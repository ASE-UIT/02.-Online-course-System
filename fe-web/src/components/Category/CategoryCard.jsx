  ...
  return (
    <div className=" border p-2 rounded-xl">
      <div className="content flex gap-10">
        ...
        <div className="title">
          <h1 className="line-clamp-2 font-bold text-xl hover:scale-105 hover:cursor-pointer">
            {category}
          </h1>
          <div className="subtcategory">
            <ul className="mt-2">
              {subcategory?.map((sub, index) => (
                <li
                  key={index}
                  className="text-md text-gray-600 hover:cursor-pointer hover:font-semibold"
                >
                  {sub}
                </li>
              ))}
