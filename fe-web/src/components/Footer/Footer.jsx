...
const Footer = () => {
  ...
  const isSignInPage = location.pathname.startsWith("/web/sign-in") || location.pathname.startsWith("/web/sign-up");
  ...
  return (
    <footer className="w-full mt-8 px-[15%] h-[355px] bg-[#EEFEE7] flex">
      <div className="basis-[60%] flex flex-col gap-6 justify-center">
        <p className="text-display/md/bold text-success-900">Trở thành giảng viên của EduHub</p>
        <p className="text-text/md/regular">
          Giảng viên trên toàn thế giới đã và đang dạy cho hàng triệu học viên trên EduHub. EduHub cung cấp công cụ và
          kỹ năng để giúp bạn hoàn thiện quá trình giảng dạy tốt hơn.
        </p>
